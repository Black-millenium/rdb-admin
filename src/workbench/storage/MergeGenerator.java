...
import workbench.db.rdb.Rdb20MergeGenerator;
import workbench.db.rdb.Rdb21MergeGenerator;
...
public interface MergeGenerator {
  ...
  class Factory {
    ...
    public static List<String> getSupportedTypes() {
      return CollectionUtil.arrayList("ansi", "db2", "firebird", "rdb", "h2", "hsqldb", "mysql", "oracle", "postgres", "sqlserver");
    }
