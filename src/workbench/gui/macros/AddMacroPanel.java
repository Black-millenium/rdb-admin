...
public class AddMacroPanel
  ...
  private void initComponents() {
    ...
    jLabel1.setText(ResourceMgr.getString("LblMacroGrpName"));
    gridBagConstraints = new GridBagConstraints();
    gridBagConstraints.anchor = GridBagConstraints.WEST;
    gridBagConstraints.insets = new Insets(7, 5, 0, 0);
    add(jLabel1, gridBagConstraints);

    jLabel2.setText(ResourceMgr.getString("LblMacroName"));
    gridBagConstraints = new GridBagConstraints();
    ...
    cbExpand.setText(ResourceMgr.getString("LblExpandMacro"));
    cbExpand.setToolTipText(ResourceMgr.getString("d_LblExpandMacro"));
    gridBagConstraints = new GridBagConstraints();
    gridBagConstraints.gridx = 0;
