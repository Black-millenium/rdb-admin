...
import static workbench.resource.GeneratedIdentifierCase.lower;
import static workbench.resource.GeneratedIdentifierCase.upper;
...
public class SqlFormatter {
  ...
  private boolean needsWhitespace(SQLToken last, SQLToken current, boolean ignoreStartOfline, boolean possibleFunction) {
    ...
    if (lastChar == catalogSeparator && currChar == '[')
      return false; // e.g. p.[id] for the dreaded SQL Server "quotes"
