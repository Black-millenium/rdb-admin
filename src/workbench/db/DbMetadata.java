...
import workbench.db.rdb.RdbDomainReader;
...
public class DbMetadata
  ...
  public static final String DBID_RDB = "rdb";
  ...
  public DbMetadata(WbConnection aConnection)
    ...
    } else if (productLower.contains("red") && productLower.contains("database")) {
      this.isRdb = true;
      dbId = "rdb";

      LogMgr.logInfo("DbMetadata.<init>", "Using DBID=" + this.dbId);
      extenders.add(new RdbDomainReader());
