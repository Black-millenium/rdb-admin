...
public class UniversalDetector {
  ...
  public void dataEnd() {
    ...
    if (this.inputState == InputState.HIGHBYTE) {
      ...
      // do nothing
    } else if (this.inputState == InputState.PURE_ASCII) {
      // Thomas Kellerer:
      // it seems the detector can sometimes not detect ANSI/ISO encodings properly
      // PURE_ASCII is a subset of the ISO encoding, so I'm using that
