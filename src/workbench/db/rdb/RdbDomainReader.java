...
public class RdbDomainReader
  ...
  final String baseSql =
      "SELECT trim(rdb$field_name) AS domain_name, \n" +
          ...
          "  AND rdb$field_name NOT LIKE 'SEC$%' "; // for Rdb 3.0
  ...
  private String getSql(WbConnection connection, String name) {
    ...
    if (Settings.getInstance().getDebugMetadataSql()) {
      LogMgr.logDebug("RdbDomainReader.getSql()", "Query to retrieve domains:\n" + sql);
    }
  ...
  public List<DomainIdentifier> getDomainList(WbConnection connection, String schemaPattern, String namePattern) {
    ...
    try {
      ...
      LogMgr.logError("RdbDomainReader.getDomainList()", "Could not read domains using query:\n" + sql, e);
    } finally {
